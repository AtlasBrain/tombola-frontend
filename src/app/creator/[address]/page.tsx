    ...
    return (
      <>
        ...
        <main className="mx-auto max-w-5xl px-4 py-12 sm:px-6">
          <h1 className="font-display text-3xl uppercase">Couldn&apos;t load</h1>
          <p className="mt-3 text-sm text-rose-400">{err}</p>
        </main>
      </>
    );
  }
      ...
      <main className="mx-auto max-w-5xl px-4 pb-12 sm:px-6">
        <section className="relative overflow-hidden rounded-2xl border border-neutral-800 bg-neutral-950 p-6 sm:rounded-3xl sm:p-10">
          <div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-start">
            <div>
              <span
                className="inline-flex items-center gap-2 rounded-md border border-neutral-800 bg-neutral-900/80 px-3 py-1.5 font-mono text-[10px] uppercase tracking-widest text-neutral-300"
              ...
              <p className="mt-2 break-all font-mono text-[10px] uppercase tracking-widest text-neutral-500">
                <a
                  href={explorerAddressUrl(address, rpcUrl)}
                  target="_blank"
                  rel="noreferrer"
              ...
              {/* Reputation badge */}
              <div
                className="mt-5 inline-flex items-start gap-3 rounded-xl border p-4"
                style={{
